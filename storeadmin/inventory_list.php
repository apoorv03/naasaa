...
if ($productCount > 0) {
	while($row = mysql_fetch_array($sql)){ 
			 ...
			 $product_list .= "Product ID: $id - <strong>$product_name</strong> - $$price - $category - $Manufacturer - $current -$min - $$Selling_Price &nbsp; &nbsp; &nbsp; <a href='inventory_edit.php?pid=$id'>edit</a> &bull; <a href='inventory_list.php?deleteid=$id'>delete</a><br />";
    }
} else {
...
<div align="left" style="margin-left:24px;">
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="6">
      ...
      <tr>
        ...
        <td><label>
          $
          <input name="Selling_Price" type="text" id="Selling_Price" size="12" />
        </label></td>
      </tr>
      <tr>
        ...
        <td><label>
          <input name="min" type="text" id="min" size="12" />
        </label></td>
      </tr>
