...
if (isset($_POST['product_name'])) {
	...
	$sql = mysql_query("UPDATE Inventory SET Product_Name='$product_name', Cost_Price='$price', Category='$Category', Manufacturer='$Manufacturer', Current_Stock='$stock', Minimum_Stock='$min', Selling_Price = '$Selling_Price' WHERE Barcode='$pid'");
	
	
	$sql = mysql_query("INSERT INTO Logbook
        VALUES('$product_name','$Category','$Manufacturer','$pid','$price','$stock','$min', '$Selling_Price')") or die (mysql_error());
...
<div align="left" style="margin-left:24px;">
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="6">
      ...
      <tr>
        ...
        <td><label>
          $
          <input name="price" type="text" id="price" size="12"  value="<?php echo $Cost_Price; ?>"/>
        </label></td>
      </tr>
      <tr>
        ...
        <td><label>
          $
          <input name="Selling_Price" type="text" id="Selling_Price" size="12"  value="<?php echo $Selling_Price; ?>"/>
        </label></td>
      </tr>
      <tr>
        ...
        <tr>
        <td align="right">Minimum Stock</td>
        <td><label>
          <input name="min" type="text" id="min" size="12" value="<?php echo $min; ?>" />
        </label></td>
      </tr>
